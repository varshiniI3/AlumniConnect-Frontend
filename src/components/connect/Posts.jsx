...
function Posts() {
  ...
  return (
    <div className="posts w-9/12 text-black relative">
        <div className="postContainer m-5 w-11/12">
            ...
            <center><div className="ml-5 w-10/12 text-left">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            </div>
            <img className='postImage h-80 w-10/12' src="https://images.unsplash.com/photo-1493612276216-ee3925520721?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cmFuZG9tfGVufDB8fDB8fHww" alt="Post"/></center>
